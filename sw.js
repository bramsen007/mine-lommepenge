const CACHE='mine-lommepenge-pilot-v1';
const ASSETS=['./','./index.html','./styles.css','./pilot-loader.js','./app.js','./manifest.webmanifest','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
